...
## :bangbang: This a fork that supports ssh tunnels :bangbang:
...
```bash
curl https://raw.githubusercontent.com/lumasepa/terraform-provider-postgresql/master/scripts/install-postgres-tf-pluging.sh | bash
```
